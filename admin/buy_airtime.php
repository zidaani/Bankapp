...
<!-- buy airtime approval -->
    ...
    <div class="col-md-12">
      <div class="card-header" style="text-align: center;margin-top: 42px;color: #fff;background: #27293c;border-radius: 14px 18px 0px 0px;">
                <h4 class="card-title">Airtime Approval</h4>
             ...
             <tr style="background: #283f6e;color: #fff;"> 
                    ...
                    $querry1 = "SELECT * FROM  transaction WHERE t_name ='airtime'and status !='approved' and amount > 0 ORDER BY t_id DESC LIMIT 5";
                         ...
                         <form action="include/airtime.php" method="post">     
                          <tr>
                             ...
                             <td>
                                ...
                                <input type="submit" name="send" value="Submit" class="process">
    ...
    <div class="col-md-12">
      <div class="card-header" style="text-align: center;margin-top: 42px;color: #fff;background: #27293c;border-radius: 14px 18px 0px 0px;">
             ...
             <tr style="background: #283f6e;color: #fff;"> 
                    ...
                    $querrya = "SELECT * FROM  transaction WHERE status='approved' and t_name ='airtime' and amount > 0 ORDER BY t_id DESC LIMIT 5";

                     $querry1resulta = mysqli_query($conn, $querrya);
                       while ($bella=mysqli_fetch_assoc($querry1resulta)) {
                        ...
                        ?>
                          ...
                          <tr>
                            ...
                            <td>
                              <?php echo $bella['status']; ?>
                            </td>


                            <td>
                          <?php echo $bella['t_name']; ?>
                            </td>


                            <td class="text-right">
                             <?php echo $bella['amount']; ?>
                            </td>

                             <td class="text-right">
                             <?php echo $bella['balance']; ?>
                            </td>
                            

                              <td>
                          <?php echo $bella['beneficiary']; ?>
                            </td>

                             <td class="text-right">
                             <?php echo $bella['airtime_carrier']; ?>
                            </td>


                            <td class="text-right">
                             <?php echo $bella['t_date']; ?>
                            </td>
