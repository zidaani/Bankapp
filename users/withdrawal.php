            ...
            <div class="card">
              ...
              <div class="card-body" style="background: #dedee2;">
                <form action="include/withdrawal.php" method="post">
                  ...
                  <div class="form-group">
                        <select name="payment_gateway" class="form-group" style="width: 26%;height: 40px;">
                  ...
                  <label>Enter Gateway Number</label>
                  <div class="form-group">
                    <input type="number" name="gateway_number" class="form-control">
                  </div>
