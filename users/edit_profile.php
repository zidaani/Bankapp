...
<!--========Account Details==========-->
 ...
 <?php if (empty($a_number)){ ?>
  ...
  <form action="include/bankupdate.php" method="post">  
  <h5 style="color: #e41;padding: 10px;font-size: 19px;background: #fff;">Before you open the account you have read and agreed to the terms and condition of the bank</h5>
...
<form action="include/pin_update.php" method="post">
    ...
    <div class="form-group">
    <input type="text" name="pin1" placeholder="Confirm Pin" class="form-control"> 
    </div>

      <div class="form-group">
      <input type="number" name="oldpin" class="form-control" placeholder="Enter Old Pin">
    </div>
    <div class="form-group">
