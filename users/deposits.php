          ...
          <div class="col-md-12">
            <div class="card">
             ...
             <tr style="background: #283f6e;color: #fff;"> 
                     ...
                     $querry1 = "SELECT * FROM  transaction WHERE u_id = '$u_id' and t_name ='deposit' and amount_credit > 0 ORDER BY t_id DESC LIMIT 10";
                ...
                <?php 
                if ($bell['status']=='unconfirmed') {
                $b1 = mysqli_query($conn,"SELECT * FROM  transaction WHERE u_id = '$u_id' and t_id ='$tt_id' ");
                    while ($b2=mysqli_fetch_assoc($b1)) { 
                         $_SESSION['user_deposit_id']=$b2['t_id'];
 } ?>
                              <td>
                             <?php echo $bell['status']; ?>
                             <a href="deposit_confirm.php">Confirm</a>
                              </td>
