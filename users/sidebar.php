...
<style>
       ul a {
        ...
        ul a:hover {
              ...
              <ul class="userul">
       		<a href="index.php"><li style="border-top: 3px solid #fff6;border-radius: 27px 0px 0px 0px;">Dashboard</li></a>
       		...
       		<a href="get_loan.php"><li > Get Loan</li></a>
                     <a href="view_message.php"><li > Veiw Message</li></a>
                     <a href="support.php"> <li style="border-bottom: 3px solid #ffffff5e;border-radius: 0px 0px 40px 0px;">Send Support</li></a>
       	</ul> <?php } else{
